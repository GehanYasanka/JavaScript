...
හරි දැන් අපි බලමු 2. Map කියන array method එක.

අපි මේකෙදි කරන්නේ loop එක run වෙනවා එතැනදී අපි එක map කර ගැනීමක් සිද්ද කරනවා ඒ කියන්නේ අපිට කලින් සදහන් කරන veriable එක අතුලෙ තියෙන text එක හරි id එක හරි isCompleted හරි මේ කියන එලෙමෙන්ට් තුනෙන් කැමති එකක් අපිට අල්ල ගණන පුළුවන් ඒ කැමති එකක් අල්ලාගෙන එයාව return කරලා  එයාව output එක හැටියට print කර ගැනීමේ හැකියාව අපිට තියෙනවා කලින් එකේදී කෙලින්ම loop කරලා output  එක ගන්න හැකියාව තිබුනට මෙතැනදී එහෙම න අපිට අදාල එක එලියට අරගෙන එයාව array එකක් ඇතුලට දල එකියන්නේ අලුතින් array එකක් නිර්මාණය වෙනවා අන්න ඒ නිර්මාණය වෙන අලුත් array එක තමයි අපි print කරන්නේ

	1. const todoText = todos.map(function(todo) {
	2.   return todo.text;  })
	3. console.log(todoText);
මෙතැනදී අපි const කියන datetype එක යටතේ 1line එකේ විදියට veriable එකක් ගන්නවා ඊට පස්සේ 2line එකේ විදියට අපි කලින් වගේ නෙමෙඉ මේකෙදි අපි return කරන්නයි ඕනේ todo.text කියන කෙනාව.
ඊටපස්සේ 3line එකේ තියෙන විදියට එක print කරන්න පුළුවන් ඒ කියන්න අලුත් array එකක් නිර්මාණය වෙලා තියෙනවා.

හරි දැන් අපි බලමු 3. Filter කියන array method එක

අපි කලින් කරේ todos  කියන verible එකේ text එක තමයි අපි array එකකට ගත්තේ හැබයි අපි එතැනදී කිසිම condition එකක් chek කරේ නැ.
හැබැයි Filter වල අපිට කොඉතිඔන් එකක් chek කරලා අලුත් array එකක් create කර ගන්න
හරි දැන් අපි උදාහරණයක් එක්කම බලමු මේකෙදි අපි කලින් කතාකර todos කියන එකම අරගමු එකේදී අපිට ඕනවෙනව isCompleted කියන එක true වෙන අය විතරක් අපිට ගන්න නම් අපි මේ code එක ලියන්න පුළුවන් එකත් maping වලදී කරපු code එකම තමයි වෙනසකට වෙන්නේ condition එකක් use වෙන එක විතරයි1. const todoCompleted = todos.filter(function(todo) {

	1. const todoCompleted = todos.filter(function(todo) {
	2.   return todo.isCompleted === true ;  })
	3. console.log(todoCompleted);

අපි මේකේ 1line එකේ තියෙන්නේ code එක වගේම තමයි  වගේම code එක හැබැයි 2line එකේදී පොඩ්ඩක් වෙනස් වෙලා තියෙනවා එකේදී අපි condition එක chek වෙල තියෙනවා එක අපි return කරලා 3line එකේ print කරලා තියෙනවා

අපිට මෙතැනදී තවදෙයක් කරන්න පුළුවන් ඒ තමයි Higher Order Array Methods කිහිපයක් එකට එකතුකරන්න පහල තියෙන code එකේ වගේ 

	1. const todoCompleted = todos.filter(function(todo) {
	2.   return todo.isCompleted === true ;  
	3.	}).map(function(todo){
	3.   return todo.text
	4. console.log(todoCompleted);

මේකෙදි වෙන්නේ isCompleted කියන එක true වෙන අවස්ථාව create වෙලා ඒ array එකෙනුත් text එක එලියට අරගෙන ඒ text එකට අදාලව අලුත් array එකක් create කරනවා todocomplete කියල ඉතින් අපි එයාවත් print කරලා තියෙනවා 4line එකේ 

හරි අපි දැන් බලමු condition වල එක විශේෂ ක්‍රමයක්

මේකෙදි අපි double pipe character පාවිච්චිකරලා අපිට පුළුවන් එක line එකකින් අපේ condition එක ලියල එකට අදාලව මොකද්ද output වෙන්න ඕනේ කියන එක සදහන් කරන්න පැහැදිලිව මේකෙදි අපිට ternary operator එක බවිත කරනන පුළුවන් මේක ඇත්තටම if statement එකේ  shorthand version එක විදියටබ් කියන්න පුළුවන්.
එක ඇත්තටම බාවිතා වෙන්නේ condition වලට variable assign කරන්න ඒ කියන්නේ condition එකක් base කරගෙන variable assign කරන්න තමයි ගොඩක් වෙලාවට ternary operator එක බාවිතා කරන්න.

අපි එක පල්ලෙහා code එකේ බලමු

	1.const x = 10
	2.const color = x > 10 ? 'red' : 'yellow';
	3.console.log(color);
මේ 2line එකේ ප්‍රශ්නාර්ථයෙන් කියවෙන්නේ x ගේ value එක 10 වඩ වැඩි නම් කියන එක ඊටපස්සේ වෙන්න ඕන දේ මේකේ විදියට නම් red කියන එක output වෙන්න ඕනේ පස්සසේ : (colon) එකෙන් කියවෙන්නේ else එකෙන් කියවෙන්නේ x ගේ value එක 10 වඩ වැඩි වෙන්නේ නැත්තම් වෙන්න ඕන දේ මේකේ විදියට නම් yellow. මේ 3line එකේ තියෙන්නේ color කියන variable එක ප්‍රින්ට් කරන්න පුළුවන්.

හරි දැන් අපි බලමු function කියන්නේ මොකද්ද කියල
javascript වල අතිශය වැදගත් දෙයක් තමයි මේ function කියන්නේ.

දැන් බලමු මුලිම කිව්වොත් function initialize කරන්නේ කොහොමද කියල මේ පල්ලෙහා 1line එකේ වගේ function keyword එකත එක්ක අපි ඒ function එකට නමක් දෙනවා ඒ නම අපි දෙන්නේ ඒ function එකෙන් කරන්න බලාපොරොත්තුවෙන කරණය පොඩ්ඩක් ඉගි කරන නමක් තමයි දෙන්නේ පල්ලෙහා code එක බැලුවම ඔයාලට තේරෙනවා ඇතිනේ එකේදී 3line එකේ තියෙන්නේ අපි parameter වලට  value pass කරපු එක 
පස්සේ අපි pass කරපු value දේක එකතුවෙලා තමයි අපිට output එක බලාගන්න පුළුවන් වෙන්නේ 
	
	1. function addnums (num1,num2){
	2. console.log(num1+num2); }
	3. addnums();

තව දෙයක් තමයි අපි value එක කෙලින්ම පෙන්නනේ නැ console.log එකක් ඇතුලේ අපි ඒ value එක return කරලා තමයි පෙන්නනේ පෙ පල්ලෙහා තියෙන code එකේ වගේ
...
හරි අපි දැන් බලමු arrow function කියන්නේ මොකද්ද කියල
මුලින්ම බලන්න ඕනේ arrow function හා normal function අතර වෙනස

arrow function වල ප්‍රදාන වෙනස තමයි අපි මෙතැනදී function කියන keyword එක බාවිතා කරන්නේ නැ
...
ඉතින් අපි මෙතැනදී බාවිතා කරන්නේ එක expression එකක් විතරක් නිසා ඒ කියන්නේ අපි මෙතැ නදී බාවිතා කරන්නේ console.log එක විතරක් හින්ද අපිට සාගල වරහන් අත්‍යවශ්‍ය නෑ අපිට මේ උද code එකේ 1line එකේ තියෙන වරහනත් අයින් කරගන්න පුළුවන් හැබැයි මේකේ අපි බාවිතා කරන්නේ එක parameter විතරක් නම් මේ පල්හේහ code එකේ 1line එකේ වගේ අපිට මේ 2line එකේ වගේ constant එකක් අපේ parameter  එකට එකතු කරන්නත් පුවන් 
	...
	1. const addnums = num1 =>
	2. return num1+8;
	3. ;
	4.console.log (addNums(67));
